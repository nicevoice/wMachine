...
jieba.load_userdict("dicts/0.txt")
jieba.load_userdict("dicts/1.txt")
jieba.load_userdict("dicts/2.txt")
jieba.load_userdict("dicts/3.txt")
jieba.load_userdict("dicts/4.txt")
import re
import os
import string
import sys
